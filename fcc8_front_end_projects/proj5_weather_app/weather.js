...
$.ajax(
  ...
  //Object "data" contains name of City, State & Country
...
// All of above simply to get the objects: location, data (more granular location info), today and forecast
        ...
        function getWeather(){
          ...
          function showForecast(tempMin, tempMax){
             for(var i=1; i<=5; i++){
              ...
              var lowTemp = "#lt"+(i);
              var highTemp = "#ht"+(i);
              document.querySelector(icon).setAttribute("src",wx.icon[i+1]);
              document.querySelector(day).textContent = wx.week[i].substring(0, 3);
              document.querySelector(fcDay).textContent = wx.sky[i+1];
